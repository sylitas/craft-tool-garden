    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <p className="text-gray-600">
            Showing <span className="font-semibold text-green-700">{filteredTools.length}</span> of <span className="font-semibold">{toolsData.length}</span> tools
          </p>
        </div>
      ...
      <footer className="bg-green-800 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4">Growing Our Tool Collection</h3>
          <p className="text-green-100 mb-6">
            Each tool in our garden is carefully crafted and maintained. New tools are added regularly by simply creating new folders in our project structure.
          </p>
